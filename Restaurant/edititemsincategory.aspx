...
<div>
    ...
    <asp:Label ID="lblName" runat="server" Text=""></asp:Label>
        ...
        UpdateCommand="UPDATE [dbo].[MenuInfo] SET [itemname] = @itemname, [price] = @price, [packing] = @packing WHERE [itemno] = @itemno"
        DeleteCommand = "delete from menuinfo where itemno=@itemno"
        SelectCommand="SELECT * FROM [MenuInfo] WHERE ([categoryno] = @categoryno)">
            <SelectParameters>
